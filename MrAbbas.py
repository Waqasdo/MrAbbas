...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Muhammad Abbas\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook.com/foji.hnyawl-xd \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Waqasdo/Aproovel.txt/blob/main/Aproovel.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/foji.hnyawl.xd")
...
def notice():
	...
	os.system("xdg-open http://alexmods.com/down/gbwhatsapp-pro/?app=fbl")
	...
	subprocess.check_output(["am", "start", "http://alexmods.com/down/gbwhatsapp-pro/?app=fbl"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Waqasdo/Aproovel.txt/blob/main/Aproovel.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Muhammad-Abbas-xd \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Mr Abbas-xd \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m CONNECT ME ON WHATAPPS\x1b[0m\x1b[1;97m] \033[1;37m ")

		subprocess.check_output(["am", "start", "http://alexmods.com/down/gbwhatsapp-pro"])
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] YouTube   : https://facebook.com/groups/431486808831636/ ")
